        ...
        public function showAds( $atts = array() ) {
                ...
                <?php if ( !$atts[ 'flat' ] ) : ?>
                    ...
                    <div class="cminds_ads_wrapper">
                        ...
                        <div style="padding-top:15px;">
                            ...
                            <?php else : ?>
                                <?php if ( $cmindsServerConnect ) : ?>
                                    You haven't refreshed the ads for <?php echo $days_since_last_refresh . ' ' . _n( 'day', 'days', $days_since_last_refresh ); ?>. <a class="cminds-ads-refresh-button" href="<?php echo add_query_arg( array( 'cminds_ad_refresh' => 1 ) ); ?>"><strong>Refresh now!</strong></a>
                                <?php endif; ?>
                            <?php endif; ?>
                            <span style="float:right;">
                                <a class="cminds-ads-hide-button" href="<?php echo add_query_arg( array( 'cminds_ad_hide' => 1 ), remove_query_arg( 'cminds_ad_show' ) ); ?>" style="font-size: larger">[Hide offers box]</a>
                            </span>
                        </div>
            ...
            <?php elseif ( $adsEnabled ): ?>
                <div class="cminds_ads_wrapper_white">
                    <a href="https://www.cminds.com/wordpress-plugins-library/seo-keyword-hound-wordpress/" target="_blank"><img src="<?php echo plugin_dir_url( __FILE__ ); ?>views/keywordhoundbanner1.png"></a>
                    <span style="margin-left:20px;">
                        <a class="" href="<?php echo add_query_arg( array( 'cminds_ad_show' => 1 ), remove_query_arg( 'cminds_ad_hide' ) ); ?>"><img src="<?php echo plugin_dir_url( __FILE__ ); ?>views/CheckCreativeMindsDiscounts.png"></a>
                    </span>
                    <span style="margin-left:20px;">
            ...
            if ( !$plaintext ):
                ...
                <table class="form-table server-info-table">
                    ...
                    <tr>
                        ...
                        <td><?php if ( version_compare( $wp_version, '4.0.0', '<' ) ): ?><strong>The minimum supported version of WordPress is 4.0</strong><?php else: ?><span>OK</span><?php endif; ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><?php if ( version_compare( phpversion(), '5.6.0', '<' ) ): ?><strong>Recommended 5.6 or higher</strong><?php else: ?><span>OK</span><?php endif; ?></td>
                    </tr>
                    <tr>
