<?php
new CMCR_Wp_Logins_Report();

class CMCR_Wp_Logins_Report extends CMCR_Report_Base {
	...
	public function init() {
		...
		add_action( 'wp_login', array( __CLASS__, 'logEvent' ) );

		/*
		 * Integration with UltimateMembership
		 */
		add_action( 'um_on_login_before_redirect', array( __CLASS__, 'umLogEvent' ) );
	}
	...
	public static function umLogEvent( $user_id ) {
		self::logEvent( um_user( 'user_login' ) );
	}

	public static function logEvent( $user_login ) {
		$data[ 'user_login' ]	 = $user_login;
		$event				 = 'wp-login';
		CMCR_Event_Log_List_Table::logEvent( $event, $data );
	}
	...
	public function getReportDescription() {
		return CM_Custom_Reports::__( 'Report number of user logins to the WP' );
	}

	public function getReportName() {
		return CM_Custom_Reports::__( 'WP Logins' );
	}
