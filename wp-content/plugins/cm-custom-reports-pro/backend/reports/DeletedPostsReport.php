<?php
new CMCR_DeletedPosts_Report();

class CMCR_DeletedPosts_Report extends CMCR_Report_Base
{
    ...
    {
        return CM_Custom_Reports::__('Report about trashed posts');
    }

    public function getReportName()
    {
        return CM_Custom_Reports::__('Trashed Posts');
    }
