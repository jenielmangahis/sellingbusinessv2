<?php
new CMCR_Views_By_Post_Report();

class CMCR_Views_By_Post_Report extends CMCR_Report_Base
{
    ...
    {
        return 'views-by-post';
    }

    public function getReportDescription()
    {
        return _('Report about post views');
    }

    public function getReportName()
    {
        return _('Views by post');
    }
