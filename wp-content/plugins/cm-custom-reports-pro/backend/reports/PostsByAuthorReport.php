<?php
new CMCR_Posts_By_Author_Report();

class CMCR_Posts_By_Author_Report extends CMCR_Report_Base
{
    ...
    {
        return CM_Custom_Reports::__('Report displays amount of posts by author');
    }

    public function getReportName()
    {
        return CM_Custom_Reports::__('Posts by Author');
    }
