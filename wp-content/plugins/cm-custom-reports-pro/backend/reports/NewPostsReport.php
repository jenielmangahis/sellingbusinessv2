<?php
new CMCR_New_Posts_Report();

class CMCR_New_Posts_Report extends CMCR_Report_Base
{
    ...
    {
        return CM_Custom_Reports::__('Report about new published posts');
    }

    public function getReportName()
    {
        return CM_Custom_Reports::__('Posts');
    }
