<?php
new CMCR_Deleted_Pages_Report();

class CMCR_Deleted_Pages_Report extends CMCR_Report_Base
{
    ...
    {
        return 'trashed-pages';
    }

    public function getReportDescription()
    {
        return CM_Custom_Reports::__('Report about trashed pages');
    }

    public function getReportName()
    {
        return CM_Custom_Reports::__('Trashed Pages');
    }
