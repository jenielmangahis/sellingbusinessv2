<?php
new CMCR_Pages_By_Author_Report();

class CMCR_Pages_By_Author_Report extends CMCR_Report_Base
{
    ...
    {
        return 'pages-by-author';
    }

    public function getReportDescription()
    {
        return CM_Custom_Reports::__('Report displays amount of pages by author');
    }

    public function getReportName()
    {
        return CM_Custom_Reports::__('Pages by Author');
    }

    public function getGroups()
    {
        return array('pages' => CM_Custom_Reports::__('Pages'));
    }
