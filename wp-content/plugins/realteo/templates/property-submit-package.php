			...
			$counter = 0;
                ...
                <div class="plan-features">
                    <ul>
                        ...
                        if(!$propertieslimit){
                            echo "<li>";
                             esc_html_e('Unlimited number of properties','realteo'); 
                             echo "</li>";
                        } else { ?>
                            <li>
                                <?php esc_html_e('This plan includes ','realteo'); printf( _n( '%d property', '%s properties', $propertieslimit, 'realteo' ) . ' ', $propertieslimit ); ?>
                            </li>
                        <?php } ?>
                        <?php if( $product->get_duration() ) { ?>
                        <li>
                            <?php esc_html_e('Properties are visible ','realteo'); printf( _n( 'for %s day', 'for %s days', $product->get_duration(), 'realteo' ), $product->get_duration() ); ?>
                        </li>
                    	<?php } ?>
