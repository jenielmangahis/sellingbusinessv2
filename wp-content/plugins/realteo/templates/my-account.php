...
$role = array_shift( $roles ); ?>
		...
		<div class="col-md-4">
			<!-- Avatar -->
			<h4 class="margin-top-0 margin-bottom-30"> <?php esc_html_e('Avatar', 'realteo'); ?></h4>
					...
					<div id="avatar-uploader" class="dropzone">
						<div class="dz-message" data-dz-message><span><?php esc_html_e('Upload Avatar', 'realteo'); ?></span></div>
					</div>
