(function ($) {
    ...
    $('.custom_posts_list_items .custom_posts_list').click(function(e){
        ...
        // dt_taxonomy param
    $('.custom_taxonomy_list_items .custom_taxonomy_list_by_ids').click(function(e){

        var $this = $(this),
            $input = $this.parents('.wpb_el_type_custom_taxonomy_list_by_ids').find('.custom_taxonomy_list_by_ids_field'),
            arr = $input.val().split(',');
